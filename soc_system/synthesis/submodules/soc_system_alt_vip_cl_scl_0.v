...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_scl_0 #(
		...
		parameter MAX_OUT_WIDTH       = 320,
		parameter MAX_OUT_HEIGHT      = 240,
	...
	soc_system_alt_vip_cl_scl_0_scaler_core scaler_core (
		.clock                    (main_clock),                             // main_clock.clk
		.reset                    (main_reset),                             // main_reset.reset
