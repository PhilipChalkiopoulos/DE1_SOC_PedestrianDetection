...
module soc_system_mm_interconnect_5 (
	...
	wire  [108:0] rsp_mux_src_data;                                                              // rsp_mux:src_data -> hps_0_h2f_axi_master_wr_rsp_width_adapter:in_data
	...
	wire  [108:0] rsp_mux_001_src_data;                                                          // rsp_mux_001:src_data -> hps_0_h2f_axi_master_rd_rsp_width_adapter:in_data
	...
	wire          rsp_mux_002_src_valid;                                                         // rsp_mux_002:src_valid -> alt_vip_vfb_0_read_master_rsp_width_adapter:in_valid
	wire  [108:0] rsp_mux_002_src_data;                                                          // rsp_mux_002:src_data -> alt_vip_vfb_0_read_master_rsp_width_adapter:in_data
	wire          rsp_mux_002_src_ready;                                                         // alt_vip_vfb_0_read_master_rsp_width_adapter:in_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                       // rsp_mux_002:src_channel -> alt_vip_vfb_0_read_master_rsp_width_adapter:in_channel
	wire          rsp_mux_002_src_startofpacket;                                                 // rsp_mux_002:src_startofpacket -> alt_vip_vfb_0_read_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_002_src_endofpacket;                                                   // rsp_mux_002:src_endofpacket -> alt_vip_vfb_0_read_master_rsp_width_adapter:in_endofpacket
	wire          alt_vip_vfb_0_read_master_rsp_width_adapter_src_valid;                         // alt_vip_vfb_0_read_master_rsp_width_adapter:out_valid -> alt_vip_vfb_0_read_master_agent:rp_valid
	wire  [126:0] alt_vip_vfb_0_read_master_rsp_width_adapter_src_data;                          // alt_vip_vfb_0_read_master_rsp_width_adapter:out_data -> alt_vip_vfb_0_read_master_agent:rp_data
	wire          alt_vip_vfb_0_read_master_rsp_width_adapter_src_ready;                         // alt_vip_vfb_0_read_master_agent:rp_ready -> alt_vip_vfb_0_read_master_rsp_width_adapter:out_ready
	wire    [3:0] alt_vip_vfb_0_read_master_rsp_width_adapter_src_channel;                       // alt_vip_vfb_0_read_master_rsp_width_adapter:out_channel -> alt_vip_vfb_0_read_master_agent:rp_channel
	wire          alt_vip_vfb_0_read_master_rsp_width_adapter_src_startofpacket;                 // alt_vip_vfb_0_read_master_rsp_width_adapter:out_startofpacket -> alt_vip_vfb_0_read_master_agent:rp_startofpacket
	wire          alt_vip_vfb_0_read_master_rsp_width_adapter_src_endofpacket;                   // alt_vip_vfb_0_read_master_rsp_width_adapter:out_endofpacket -> alt_vip_vfb_0_read_master_agent:rp_endofpacket
	wire          rsp_mux_003_src_valid;                                                         // rsp_mux_003:src_valid -> alt_vip_vfb_0_write_master_rsp_width_adapter:in_valid
	wire  [108:0] rsp_mux_003_src_data;                                                          // rsp_mux_003:src_data -> alt_vip_vfb_0_write_master_rsp_width_adapter:in_data
	wire          rsp_mux_003_src_ready;                                                         // alt_vip_vfb_0_write_master_rsp_width_adapter:in_ready -> rsp_mux_003:src_ready
	wire    [3:0] rsp_mux_003_src_channel;                                                       // rsp_mux_003:src_channel -> alt_vip_vfb_0_write_master_rsp_width_adapter:in_channel
	wire          rsp_mux_003_src_startofpacket;                                                 // rsp_mux_003:src_startofpacket -> alt_vip_vfb_0_write_master_rsp_width_adapter:in_startofpacket
	wire          rsp_mux_003_src_endofpacket;                                                   // rsp_mux_003:src_endofpacket -> alt_vip_vfb_0_write_master_rsp_width_adapter:in_endofpacket
	wire          alt_vip_vfb_0_write_master_rsp_width_adapter_src_valid;                        // alt_vip_vfb_0_write_master_rsp_width_adapter:out_valid -> alt_vip_vfb_0_write_master_agent:rp_valid
	wire  [126:0] alt_vip_vfb_0_write_master_rsp_width_adapter_src_data;                         // alt_vip_vfb_0_write_master_rsp_width_adapter:out_data -> alt_vip_vfb_0_write_master_agent:rp_data
	wire          alt_vip_vfb_0_write_master_rsp_width_adapter_src_ready;                        // alt_vip_vfb_0_write_master_agent:rp_ready -> alt_vip_vfb_0_write_master_rsp_width_adapter:out_ready
	wire    [3:0] alt_vip_vfb_0_write_master_rsp_width_adapter_src_channel;                      // alt_vip_vfb_0_write_master_rsp_width_adapter:out_channel -> alt_vip_vfb_0_write_master_agent:rp_channel
	wire          alt_vip_vfb_0_write_master_rsp_width_adapter_src_startofpacket;                // alt_vip_vfb_0_write_master_rsp_width_adapter:out_startofpacket -> alt_vip_vfb_0_write_master_agent:rp_startofpacket
	wire          alt_vip_vfb_0_write_master_rsp_width_adapter_src_endofpacket;                  // alt_vip_vfb_0_write_master_rsp_width_adapter:out_endofpacket -> alt_vip_vfb_0_write_master_agent:rp_endofpacket
	...
	wire  [108:0] hps_0_h2f_axi_master_wr_cmd_width_adapter_src_data;                            // hps_0_h2f_axi_master_wr_cmd_width_adapter:out_data -> cmd_demux:sink_data
	...
	wire  [108:0] hps_0_h2f_axi_master_rd_cmd_width_adapter_src_data;                            // hps_0_h2f_axi_master_rd_cmd_width_adapter:out_data -> cmd_demux_001:sink_data
	...
	wire          router_002_src_valid;                                                          // router_002:src_valid -> alt_vip_vfb_0_read_master_cmd_width_adapter:in_valid
	wire  [126:0] router_002_src_data;                                                           // router_002:src_data -> alt_vip_vfb_0_read_master_cmd_width_adapter:in_data
	wire          router_002_src_ready;                                                          // alt_vip_vfb_0_read_master_cmd_width_adapter:in_ready -> router_002:src_ready
	wire    [3:0] router_002_src_channel;                                                        // router_002:src_channel -> alt_vip_vfb_0_read_master_cmd_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                                  // router_002:src_startofpacket -> alt_vip_vfb_0_read_master_cmd_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                                    // router_002:src_endofpacket -> alt_vip_vfb_0_read_master_cmd_width_adapter:in_endofpacket
	wire          alt_vip_vfb_0_read_master_cmd_width_adapter_src_valid;                         // alt_vip_vfb_0_read_master_cmd_width_adapter:out_valid -> cmd_demux_002:sink_valid
	wire  [108:0] alt_vip_vfb_0_read_master_cmd_width_adapter_src_data;                          // alt_vip_vfb_0_read_master_cmd_width_adapter:out_data -> cmd_demux_002:sink_data
	wire          alt_vip_vfb_0_read_master_cmd_width_adapter_src_ready;                         // cmd_demux_002:sink_ready -> alt_vip_vfb_0_read_master_cmd_width_adapter:out_ready
	wire    [3:0] alt_vip_vfb_0_read_master_cmd_width_adapter_src_channel;                       // alt_vip_vfb_0_read_master_cmd_width_adapter:out_channel -> cmd_demux_002:sink_channel
	wire          alt_vip_vfb_0_read_master_cmd_width_adapter_src_startofpacket;                 // alt_vip_vfb_0_read_master_cmd_width_adapter:out_startofpacket -> cmd_demux_002:sink_startofpacket
	wire          alt_vip_vfb_0_read_master_cmd_width_adapter_src_endofpacket;                   // alt_vip_vfb_0_read_master_cmd_width_adapter:out_endofpacket -> cmd_demux_002:sink_endofpacket
	wire          router_003_src_valid;                                                          // router_003:src_valid -> alt_vip_vfb_0_write_master_cmd_width_adapter:in_valid
	wire  [126:0] router_003_src_data;                                                           // router_003:src_data -> alt_vip_vfb_0_write_master_cmd_width_adapter:in_data
	wire          router_003_src_ready;                                                          // alt_vip_vfb_0_write_master_cmd_width_adapter:in_ready -> router_003:src_ready
	wire    [3:0] router_003_src_channel;                                                        // router_003:src_channel -> alt_vip_vfb_0_write_master_cmd_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                                  // router_003:src_startofpacket -> alt_vip_vfb_0_write_master_cmd_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                                    // router_003:src_endofpacket -> alt_vip_vfb_0_write_master_cmd_width_adapter:in_endofpacket
	wire          alt_vip_vfb_0_write_master_cmd_width_adapter_src_valid;                        // alt_vip_vfb_0_write_master_cmd_width_adapter:out_valid -> cmd_demux_003:sink_valid
	wire  [108:0] alt_vip_vfb_0_write_master_cmd_width_adapter_src_data;                         // alt_vip_vfb_0_write_master_cmd_width_adapter:out_data -> cmd_demux_003:sink_data
	wire          alt_vip_vfb_0_write_master_cmd_width_adapter_src_ready;                        // cmd_demux_003:sink_ready -> alt_vip_vfb_0_write_master_cmd_width_adapter:out_ready
	wire    [3:0] alt_vip_vfb_0_write_master_cmd_width_adapter_src_channel;                      // alt_vip_vfb_0_write_master_cmd_width_adapter:out_channel -> cmd_demux_003:sink_channel
	wire          alt_vip_vfb_0_write_master_cmd_width_adapter_src_startofpacket;                // alt_vip_vfb_0_write_master_cmd_width_adapter:out_startofpacket -> cmd_demux_003:sink_startofpacket
	wire          alt_vip_vfb_0_write_master_cmd_width_adapter_src_endofpacket;                  // alt_vip_vfb_0_write_master_cmd_width_adapter:out_endofpacket -> cmd_demux_003:sink_endofpacket
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (alt_vip_vfb_0_read_master_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (alt_vip_vfb_0_read_master_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (alt_vip_vfb_0_read_master_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (alt_vip_vfb_0_read_master_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (alt_vip_vfb_0_read_master_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (alt_vip_vfb_0_read_master_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                             // (terminated)
		.av_writeresponsevalid ()                                                                              // (terminated)
	);
	...
	altera_merlin_master_agent #(
		...
		.rp_valid              (alt_vip_vfb_0_write_master_rsp_width_adapter_src_valid),                        //        rp.valid
		.rp_data               (alt_vip_vfb_0_write_master_rsp_width_adapter_src_data),                         //          .data
		.rp_channel            (alt_vip_vfb_0_write_master_rsp_width_adapter_src_channel),                      //          .channel
		.rp_startofpacket      (alt_vip_vfb_0_write_master_rsp_width_adapter_src_startofpacket),                //          .startofpacket
		.rp_endofpacket        (alt_vip_vfb_0_write_master_rsp_width_adapter_src_endofpacket),                  //          .endofpacket
		.rp_ready              (alt_vip_vfb_0_write_master_rsp_width_adapter_src_ready),                        //          .ready
		.av_response           (),                                                                              // (terminated)
		.av_writeresponsevalid ()                                                                               // (terminated)
	);
	...
	soc_system_mm_interconnect_5_router router_001 (
	...
	soc_system_mm_interconnect_5_router_002 router_003 (
	...
	soc_system_mm_interconnect_5_router_004 router_004 (
	...
	soc_system_mm_interconnect_5_cmd_demux_002 cmd_demux_002 (
		.clk                (pll_0_outclk0_clk),                                             //       clk.clk
		.reset              (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		.sink_ready         (alt_vip_vfb_0_read_master_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (alt_vip_vfb_0_read_master_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (alt_vip_vfb_0_read_master_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (alt_vip_vfb_0_read_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (alt_vip_vfb_0_read_master_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (alt_vip_vfb_0_read_master_cmd_width_adapter_src_valid),         //          .valid
	...
	soc_system_mm_interconnect_5_cmd_demux_002 cmd_demux_003 (
		.clk                (pll_0_outclk0_clk),                                              //       clk.clk
		.reset              (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		.sink_ready         (alt_vip_vfb_0_write_master_cmd_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (alt_vip_vfb_0_write_master_cmd_width_adapter_src_channel),       //          .channel
		.sink_data          (alt_vip_vfb_0_write_master_cmd_width_adapter_src_data),          //          .data
		.sink_startofpacket (alt_vip_vfb_0_write_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (alt_vip_vfb_0_write_master_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (alt_vip_vfb_0_write_master_cmd_width_adapter_src_valid),         //          .valid
	...
	soc_system_mm_interconnect_5_rsp_mux rsp_mux_002 (
		.clk                 (pll_0_outclk0_clk),                               //       clk.clk
		.reset               (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_5_rsp_mux rsp_mux_003 (
		.clk                 (pll_0_outclk0_clk),                               //       clk.clk
		.reset               (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) alt_vip_vfb_0_read_master_rsp_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                             //       clk.clk
		.reset                (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		...
		.out_endofpacket      (alt_vip_vfb_0_read_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_vfb_0_read_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_vfb_0_read_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_vfb_0_read_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_vfb_0_read_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_vfb_0_read_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                         // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) alt_vip_vfb_0_write_master_rsp_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                              //       clk.clk
		.reset                (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (alt_vip_vfb_0_write_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_vfb_0_write_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_vfb_0_write_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_vfb_0_write_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_vfb_0_write_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_vfb_0_write_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                          // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) alt_vip_vfb_0_read_master_cmd_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                             //       clk.clk
		.reset                (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		...
		.out_endofpacket      (alt_vip_vfb_0_read_master_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_vfb_0_read_master_cmd_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_vfb_0_read_master_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_vfb_0_read_master_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_vfb_0_read_master_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_vfb_0_read_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                         // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) alt_vip_vfb_0_write_master_cmd_width_adapter (
		.clk                  (pll_0_outclk0_clk),                                              //       clk.clk
		.reset                (alt_vip_vfb_0_reset_reset_bridge_in_reset_reset),                // clk_reset.reset
		...
		.out_endofpacket      (alt_vip_vfb_0_write_master_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_vip_vfb_0_write_master_cmd_width_adapter_src_data),          //          .data
		.out_channel          (alt_vip_vfb_0_write_master_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_vip_vfb_0_write_master_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_vip_vfb_0_write_master_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_vip_vfb_0_write_master_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                          // (terminated)
	);
