...
`timescale 1 ps / 1 ps
module soc_system_alt_vip_cl_clp_0 #(
		...
		parameter RECTANGLE_WIDTH              = 320,
		parameter RECTANGLE_HEIGHT             = 240,
